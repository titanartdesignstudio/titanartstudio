...
export default function Customers() {
  return (
    <section className="relative py-12 sm:py-16 px-4 sm:px-6 overflow-hidden reveal">
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        {/* Heading */}
        <p className="text-[10px] sm:text-xs text-white/40 uppercase tracking-[0.25em] sm:tracking-[0.35em] mb-8 sm:mb-10 px-2">
          Trusted by leading brands
        </p>

        {/* fade edges */}
        <div className="absolute left-0 top-0 h-full w-16 sm:w-28 bg-gradient-to-r from-[#020617] to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 h-full w-16 sm:w-28 bg-gradient-to-l from-[#020617] to-transparent z-10 pointer-events-none" />

        {/* LOGO STRIP */}
        <div className="relative overflow-hidden">

          <div className="flex gap-8 sm:gap-12 md:gap-16 animate-marquee items-center">
